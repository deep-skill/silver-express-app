...
class BookingCreate extends ConsumerWidget {
      ...
      child: Row(
        ...
        children: [
          ...
          ElevatedButton(
              ...
              onPressed: () {
                showAlert1(context, ref, emailController, nameController,
...
void showAlert1(BuildContext context, ref, emailController, nameController,
    phoneController, licenseController, addressController) {
  showDialog(
